...
-- 初始化-部门表数据
-- ----------------------------
insert into sys_dept values(100,  0,   '0',          '井冈山大学',   0, 'cdy', '13888888888', 'equipment@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(101,  100, '0,100',      '电子与信息工程学院', 1, 'cdy', '13888888888', 'equipment@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(102,  100, '0,100',      '马克思主义学院', 2, 'cdy', '13888888888', 'equipment@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(103,  101, '0,100,101',  '计算机科学技术',   1, 'cdy', '13888888888', 'equipment@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(104,  101, '0,100,101',  '软件工程',   2, 'cdy', '13888888888', 'equipment@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(105,  101, '0,100,101',  '电子与科学技术',   3, 'cdy', '13888888888', 'equipment@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(106,  101, '0,100,101',  '信息与通程工程',   4, 'cdy', '13888888888', 'equipment@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(107,  101, '0,100,101',  '测绘科学与技术',   5, 'cdy', '13888888888', 'equipment@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(108,  102, '0,100,102',  '中共党史系',   1, 'cdy', '13888888888', 'equipment@qq.com', '0', '0', 'admin', sysdate(), '', null);
insert into sys_dept values(109,  102, '0,100,102',  '思想政治教育系',   2, 'cdy', '13888888888', 'equipment@qq.com', '0', '0', 'admin', sysdate(), '', null);
...
-- 初始化-用户信息表数据
-- ----------------------------
insert into sys_user values(1,  103, 'admin', 'cdy', '00', '1388888888@163.com', '15888888888', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '管理员');
insert into sys_user values(2,  105, 'tom',    'tom', '00', '1588888888@qq.com',  '17666666666', '1', '', '$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2', '0', '0', '127.0.0.1', sysdate(), 'admin', sysdate(), '', null, '测试员');
...
insert into sys_post values(2, 'user', '副校长',  2, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(3, 'se',   '教师',  3, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(4, 'hr',   '数据员',  4, '0', 'admin', sysdate(), '', null, '');
insert into sys_post values(5, 'user', '管理员',  5, '0', 'admin', sysdate(), '', null, '');
...
insert into sys_menu values('4', '若依官网', '0', '4', 'http://equipment.vip', null, '', 0, 0, 'M', '0', '0', '', 'guide',    'admin', sysdate(), '', null, '若依官网地址');
-- 二级菜单
